...
class InquiryController extends SecureController{
	...
	function add($formdata = null){
		...
		if($formdata){
			...
			$fields = $this->fields = array("prospect_name","prospect_phone","select_location","platform","datetime","assign_agent_name","assign_agent_phone","remark","handled");
		...
		# Statement to execute before adding record
                ...
                $agentphone                      = $this->formatPhone($db->rawQueryValue("SELECT agent_phone FROM agent WHERE agent_location = '$location' and status1 = '0' limit 1"));
                 ...
                 //$agency = $db->rawQueryValue("SELECT agency_name FROM agent WHERE agent_name = '$agentname'");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$fields = $this->fields = array("id","prospect_name","prospect_phone","select_location","platform","remark","handled");
