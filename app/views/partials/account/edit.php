                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-username"  value="<?php  echo $data['username']; ?>" type="email" placeholder="Enter Username"  required="" name="username"  data-url="api/json/account_username_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                        ...
                                        <input id="ctrl-pass_text"  value="<?php  echo $data['pass_text']; ?>" type="hidden" placeholder="Enter Pass Text"  required="" name="pass_text"  class="form-control " />
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-agent_name"  value="<?php  echo $data['agent_name']; ?>" type="email" placeholder="Enter Agent Name"  required="" name="agent_name"  data-url="api/json/account_agent_name_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                                <div class="check-status"></div> 
                                                            </div>
                                                        </div>
                                                    </div>
