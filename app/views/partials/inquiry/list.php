                                ...
                                <table class="table  table-striped table-sm text-left table-bordered">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <th class="td-select_location"> Select Location</th>

                                            <th class="td-handled">Budget Rental</th>
                                            <th class="td-platform"> Platform</th>
                                            <th class="td-datetime"> Datetime</th>
                                            <th class="td-assign_agent_name"> Assign Agent</th>
                                            <th class="td-remark"> Assign Agent Phone</th>
                                        </tr>
                                    </thead>
                                    <?php
                                    if (!empty($records)) {
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="td-select_location"> <?php echo $data['select_location']; ?></td>
                                                    <td class="td-budget_rental"> <?php echo $data['budget_rental']; ?></td>
                                                    ...
                                                    <td class="td-assign_agent_phone"><?php echo $data['assign_agent_phone']; ?></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
